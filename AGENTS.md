...
1. Search for open PRs that may already address the issue: `gh pr list --repo singi-labs/barazo-lexicons --state open`
2. Search for related branches: `gh api repos/singi-labs/barazo-lexicons/branches --paginate`
...
git worktree add /tmp/barazo-lexicons-<branch-name> -b <branch-name> origin/main

# Work in the worktree
cd /tmp/barazo-lexicons-<branch-name>

# When done, remove the worktree
git worktree remove /tmp/barazo-lexicons-<branch-name>
```

Never work directly in the main checkout (`/singi-labs/repos/barazo-lexicons/`). Always create a worktree per issue. Clean up the worktree after the PR is merged.
